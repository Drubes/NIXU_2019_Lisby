...
t5=0x652
t6=0x722
breakpoints=[t1,t2,t3,t4,t6,0x7ae]
...
def do_something (opcode, p):
    ...
    if old_p in breakpoints:
        ...
        while 1 :
            ...
            if "b " in cm:
                try:
                    breakpoints.append(int(cm[1:],16))
                except:
                    print"you fail"
                cm = "ib"
            if "d " in cm:
                try:
                    breakpoints.pop(int(cm[1:]))
                except:
                    print"you fail"
                cm = "ib"
            ...
            if cm == "h" or cm == "help":
                print "     "+"*"*61+"\n"\
                      "     *    ENTER repeats last command".ljust(66)+"*\n"\
                      "     *"+" ".ljust(59)+"*\n"\
                      "     *    h or help    This menu".ljust(67)+"*\n"\
                      "     *    c            continue to next breakpoint".ljust(67)+"*\n"\
                      "     *    s            step to next instruction".ljust(67)+"*\n"\
                      "     *    b <offset>   place breakpoint on offset".ljust(67)+"*\n"\
                      "     *    d <number>   delete breakpoint.".ljust(67)+"*\n"\
                      "     *    ib           info breakpoints".ljust(67)+"*\n"\
                      "     *    p            interactive shell".ljust(67)+"*\n"\
                      "     *    q or quit    quit".ljust(67)+"*\n"\
                      "     "+"*"*61+"\n"
